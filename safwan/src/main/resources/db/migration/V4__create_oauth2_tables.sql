...
CREATE TABLE authorization (
    ...
    PRIMARY KEY (id),
    CONSTRAINT fk_authorization_registered_client FOREIGN KEY (registered_client_id) REFERENCES client(id)
);
...
CREATE TABLE authorization_consent (
    ...
    CONSTRAINT fk_authorization_consent_registered_client FOREIGN KEY (registered_client_id) REFERENCES client(id)
);
